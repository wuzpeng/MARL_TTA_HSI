...
def _get_prepare_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--env-name", type=str, default='HarFang',
                       help="specify the name of environment")
    group.add_argument("--algorithm-name", type=str, default='mappo', choices=["ppo", "mappo", "happo", "masac"],
                       help="Specifiy the algorithm (default ppo)")
    group.add_argument("--experiment-name", type=str, default="3D_weight",
                       help="An identifier to distinguish different experiment.")
    group.add_argument("--seed", type=int, default=0,
                       help="Random seed for numpy/torch")
    group.add_argument("--cuda", action='store_true', default=True,
    ...
    group.add_argument("--num-env-steps", type=float, default=1e8,
...
def _get_replaybuffer_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--buffer-size", type=int, default=2000,
...
def _get_recurrent_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--data-chunk-length", type=int, default=8,
...
def _get_ppo_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--num-mini-batch", type=int, default=2,
                       help='number of batches for ppo (default: 1)')
    group.add_argument("--value-loss-coef", type=float, default=1,
                       help='ppo value loss coefficient (default: 1)')
    group.add_argument("--entropy-coef", type=float, default=1e-3,
...
def _get_log_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--log-interval", type=int, default=1,
                       help="time duration between continuous twice log printing. (default 5)")
    return parser
